...
from BADMUNDA.database.lovedb import get_couple, save_couple
...
COUPLES_PIC = "https://graph.org/file/c92e0884671668a0032e5.jpg"
C = """
✧ 🌸 ᴄᴏᴜᴘʟᴇs ᴏғ ᴛʜᴇ ᴅᴀʏ 🌸 ✧
➖➖➖➖➖➖➖➖➖➖➖➖
{} + ( PGM🎀😶 (https://t.me/Chalnayaaaaaarr) + 花火 (https://t.me/zd_sr07) + ゼロツー (https://t.me/wewewe_x) ) = 💞
➖➖➖➖➖➖➖➖➖➖➖➖
❤️ ɴᴇᴡ ᴄᴏᴜᴘʟᴇ ᴏғ ᴛʜᴇ ᴅᴀʏ ᴄᴀɴ ʙᴇ ᴄʜᴏsᴇɴ ᴀᴛ 🌸 12AM {}
"""
CAP = """
✧🌸 ᴄᴏᴜᴘʟᴇs ᴏғ ᴛʜᴇ ᴅᴀʏ 🌸 ✧
➖➖➖➖➖➖➖➖➖➖➖➖
{} + {} = 💞
➖➖➖➖➖➖➖➖➖➖➖➖
❤️ ɴᴇᴡ ᴄᴏᴜᴘʟᴇ ᴏғ ᴛʜᴇ ᴅᴀʏ ᴄᴀɴ ʙᴇ ᴄʜᴏsᴇɴ ᴀᴛ ❤️ 12AM {}
"""
...
@BAD.on_message(filters.command(["couple", "couples", "shipping"]) & ~filters.private)
async def nibba_nibbi(_, message):
    if message.from_user.id == 6465468935:
        my_ = await _.get_users("rfxtuv")
        me = await _.get_users(6465468935)
...
➖➖➖➖➖➖➖➖➖➖➖➖
❤️ ɴᴇᴡ ᴄᴏᴜᴘʟᴇ ᴏғ ᴛʜᴇ ᴅᴀʏ ᴄᴀɴ ʙᴇ ᴄʜᴏsᴇɴ ᴀᴛ ❤️ 12AM {tomorrow}"""
                await _.send_photo(
