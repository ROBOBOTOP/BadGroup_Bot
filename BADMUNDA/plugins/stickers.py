...
from BADMUNDA.utils.sticker_help import *
from BADMUNDA.utils.web_helpers import get_file_size
from BADMUNDA.vars import Config


@BAD.on_message(command(["stickerinfo","stinfo"]))
async def give_st_info(c: BAD , m: Message):
...
@BAD.on_message(command(["stickerid","stid"]))
async def sticker_id_gib(c: BAD, m: Message):
    if not m.reply_to_message:
        await m.reply_text("Reply to a sticker")
        return
    elif not m.reply_to_message.sticker:
...
@BAD.on_message(command(["kang", "steal"]))
async def kang(c:BAD, m: Message):
    if not m.reply_to_message:
...
@BAD.on_message(command(["mmfb","mmfw","mmf"]))
async def memify_it(c: BAD, m: Message):
    if not m.reply_to_message:
...
@BAD.on_message(command(["getsticker","getst"]))
async def get_sticker_from_file(c: BAD, m: Message):
...
__HELP__ = """
**Usᴇʀ Cᴏᴍᴍᴀɴᴅs:**
• /ᴋᴀɴɢ (/sᴛᴇᴀʟ) <ᴇᴍᴏᴊɪ>: Rᴇᴘʟʏ ᴛᴏ ᴀ sᴛɪᴄᴋᴇʀ ᴏʀ ᴀɴʏ sᴜᴘᴘᴏʀᴛᴇᴅ ᴍᴇᴅɪᴀ
• /sᴛɪᴄᴋᴇʀɪɴғᴏ (/sᴛɪɴғᴏ) : Rᴇᴘʟʏ ᴛᴏ ᴀɴʏ sᴛɪᴄᴋᴇʀ ᴛᴏ ɢᴇᴛ ɪᴛ's ɪɴғᴏ
• /ɢᴇᴛsᴛɪᴄᴋᴇʀ (/ɢᴇᴛsᴛ) : Gᴇᴛ sᴛɪᴄᴋᴇʀ ᴀs ᴘʜᴏᴛᴏ, ɢɪғ ᴏʀ ᴠɪᴄᴇ ᴠᴇʀsᴀ.
• /sᴛɪᴄᴋᴇʀɪᴅ (/sᴛɪᴅ) : Rᴇᴘʟʏ ᴛᴏ ᴀɴʏ sᴛɪᴄᴋᴇʀ ᴛᴏ ɢᴇᴛ ɪᴛ's ɪᴅ
• /ᴍᴍғ <ʏᴏᴜʀ ᴛᴇxᴛ>: Rᴇᴘʟʏ ᴛᴏ ᴀ ɴᴏʀᴍᴀʟ sᴛɪᴄᴋᴇʀ ᴏʀ ᴀ ᴘʜᴏᴛᴏ ᴏʀ ᴠɪᴅᴇᴏ ғɪʟᴇ ᴛᴏ ᴍᴇᴍɪғʏ ɪᴛ. Iғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ʀɪɢʜᴛ ᴛᴇxᴛ ᴀᴛ ʙᴏᴛᴛᴏᴍ ᴜsᴇ ;ʀɪɢʜᴛ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ
    ■ Fᴏʀ ᴇ.ɢ. 
    ○ /ᴍᴍғ Hᴇʟʟᴏ ғʀᴇɪɴᴅs : ᴛʜɪs ᴡɪʟʟ ᴀᴅᴅ ᴛᴇxᴛ ᴛᴏ ᴛʜᴇ ᴛᴏᴘ
    ○ /ᴍᴍғ Hᴇʟʟᴏ ; ғʀᴇɪɴᴅs : ᴛʜɪs ᴡɪʟʟ ᴀᴅᴅ Hᴇʟʟᴏ ᴛᴏ ᴛʜᴇ ᴛᴏᴘ ᴀɴᴅ ғʀᴇɪɴᴅs ᴀᴛ ᴛʜᴇ ʙᴏᴛᴛᴏᴍ
    ○ /ᴍᴍғ ; Hᴇʟʟᴏ ғʀɪᴇɴᴅs : ᴛʜɪs ᴡɪʟʟ ᴀᴅᴅ ᴛᴇxᴛ ᴀᴛ ᴛʜᴇ ʙᴏᴛᴛᴏᴍ
    ○ /ᴍᴍғʙ <ᴛᴇxᴛ>: Tᴏ ғɪʟʟ ᴛᴇxᴛ ᴡɪᴛʜ ʙʟᴀᴄᴋ ᴄᴏʟᴏᴜʀ
    ○ /ᴍᴍғᴡ ᴏʀ /ᴍᴍғ <ᴛᴇxᴛ>: Tᴏ ғɪʟʟ ɪᴛ ᴡɪᴛʜ ᴡʜɪᴛᴇ ᴄᴏʟᴏᴜʀ

Nᴏᴛᴇ
ᴍᴍғ ᴀɴᴅ ɢᴇᴛsᴛɪᴄᴋᴇʀ ᴏɴʟʏ sᴜᴘᴘᴏʀᴛ ᴘʜᴏᴛᴏ ᴀɴᴅ ɴᴏʀᴍᴀʟ sᴛɪᴄᴋᴇʀs ғᴏʀ ɴᴏᴡ.
