...
from BADMUNDA.database.antispam_db import GBan
...
from BADMUNDA.utils.custom_filters import admin_filter, bot_admin_filter, command
from BADMUNDA.utils.kbhelpers import ikb
from BADMUNDA.utils.msg_types import Types, get_wlcm_type
from BADMUNDA.utils.parser import escape_markdown, mention_html
from BADMUNDA.utils.string import (build_keyboard, escape_invalid_curly_brackets,
                                 parse_button)
...
@BAD.on_message(command("cleanwelcome") & admin_filter)
...
@BAD.on_message(command("cleangoodbye") & admin_filter)
...
@BAD.on_message(command("cleanservice") & admin_filter)
...
@BAD.on_message(command("setwelcome") & admin_filter & bot_admin_filter)
...
@BAD.on_message(command("setgoodbye") & admin_filter & bot_admin_filter)
...
@BAD.on_message(command("resetgoodbye") & admin_filter & bot_admin_filter)
...
@BAD.on_message(command("resetwelcome") & admin_filter & bot_admin_filter)
...
@BAD.on_message(filters.service & filters.group, group=59)
...
@BAD.on_chat_member_updated(filters.group, group=69)
async def member_has_joined(c: BAD, member: ChatMemberUpdated):
...
@BAD.on_chat_member_updated(filters.group, group=99)
async def member_has_left(c: BAD, member: ChatMemberUpdated):
...
@BAD.on_message(command("welcome") & admin_filter)
async def welcome(c: BAD, m: Message):
    db = Greetings(m.chat.id)
    status = db.get_welcome_status()
    oo = db.get_welcome_text()
    args = m.text.split(" ", 1)
...
@BAD.on_message(command("goodbye") & admin_filter)
async def goodbye(c: BAD, m: Message):
    db = Greetings(m.chat.id)
    status = db.get_goodbye_status()
    oo = db.get_goodbye_text()
    args = m.text.split(" ", 1)
...
Cᴜsᴛᴏᴍɪᴢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ's ᴡᴇʟᴄᴏᴍᴇ / ɢᴏᴏᴅʙʏᴇ ᴍᴇssᴀɢᴇs ᴛʜᴀᴛ ᴄᴀɴ ʙᴇ ᴘᴇʀsᴏɴᴀʟɪsᴇᴅ ɪɴ ᴍᴜʟᴛɪᴘʟᴇ ᴡᴀʏs.

Nᴏᴛᴇ:
× Cᴜʀʀᴇɴᴛʟʏ ɪᴛ sᴜᴘᴘᴏʀᴛs ᴏɴʟʏ ᴛᴇxᴛ!
× BAD ᴍᴜsᴛ ʙᴇ ᴀɴ ᴀᴅᴍɪɴ ᴛᴏ ɢʀᴇᴇᴛ ᴀɴᴅ ɢᴏᴏᴅʙʏᴇ ᴜsᴇʀs.

Aᴅᴍɪɴ Cᴏᴍᴍᴀɴᴅs:
• /sᴇᴛᴡᴇʟᴄᴏᴍᴇ <ʀᴇᴘʟʏ> : Sᴇᴛs ᴀ ᴄᴜsᴛᴏᴍ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇ.
• /sᴇᴛɢᴏᴏᴅʙʏᴇ <ʀᴇᴘʟʏ> : Sᴇᴛs ᴀ ᴄᴜsᴛᴏᴍ ɢᴏᴏᴅʙʏᴇ ᴍᴇssᴀɢᴇ.
• /ʀᴇsᴇᴛᴡᴇʟᴄᴏᴍᴇ : Rᴇsᴇᴛs ᴛᴏ ʙᴏᴛ ᴅᴇғᴀᴜʟᴛ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇ.
• /ʀᴇsᴇᴛɢᴏᴏᴅʙʏᴇ : Rᴇsᴇᴛs ᴛᴏ ʙᴏᴛ ᴅᴇғᴀᴜʟᴛ ɢᴏᴏᴅʙʏᴇ ᴍᴇssᴀɢᴇ.
• /ᴡᴇʟᴄᴏᴍᴇ <ᴏɴ/ᴏғғ> | ɴᴏғᴏʀᴍᴀᴛ : ᴇɴᴀʙʟᴇ/ᴅɪsᴀʙʟᴇ | Sʜᴏᴡs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴡᴇʟᴄᴏᴍᴇ ᴍᴇssᴀɢᴇ | sᴇᴛᴛɪɴɢs.
• /ɢᴏᴏᴅʙʏᴇ <ᴏɴ/ᴏғғ> | ɴᴏғᴏʀᴍᴀᴛ : ᴇɴᴀʙʟᴇ/ᴅɪsᴀʙʟᴇ | Sʜᴏᴡs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ɢᴏᴏᴅʙʏᴇ ᴍᴇssᴀɢᴇ | sᴇᴛᴛɪɴɢs.
• /ᴄʟᴇᴀɴᴡᴇʟᴄᴏᴍᴇ <ᴏɴ/ᴏғғ> : Sʜᴏᴡs ᴏʀ sᴇᴛs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴄʟᴇᴀɴ ᴡᴇʟᴄᴏᴍᴇ sᴇᴛᴛɪɴɢs.
• /ᴄʟᴇᴀɴɢᴏᴏᴅʙʏᴇ <ᴏɴ/ᴏғғ> : Sʜᴏᴡs ᴏʀ sᴇᴛs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴄʟᴇᴀɴ ɢᴏᴏᴅʙʏᴇ sᴇᴛᴛɪɴɢs.

Cʟᴇᴀɴᴇʀ:
• /ᴄʟᴇᴀɴsᴇʀᴠɪᴄᴇ <ᴏɴ/ᴏғғ> : Usᴇ ɪᴛ ᴛᴏ ᴄʟᴇᴀɴ ᴀʟʟ sᴇʀᴠɪᴄᴇ ᴍᴇssᴀɢᴇs ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴏʀ ᴛᴏ ᴠɪᴇᴡ ᴄᴜʀʀᴇɴᴛ sᴛᴀᴛᴜs.
