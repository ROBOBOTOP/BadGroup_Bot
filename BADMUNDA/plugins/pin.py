...
@BAD.on_message(command("pin") & admin_filter)
...
@BAD.on_message(command("unpin") & admin_filter)
async def unpin_message(c: BAD, m: Message):
    try:
        if m.reply_to_message:
...
@BAD.on_message(command("unpinall") & admin_filter)
...
@BAD.on_callback_query(regex("^unpin_all_in_this_chat$"))
async def unpinall_calllback(c: BAD, q: CallbackQuery):
...
@BAD.on_message(command("antichannelpin") & admin_filter)
...
@BAD.on_message(command("pinned") & admin_filter)
async def pinned_message(c: BAD, m: Message):
...
@BAD.on_message(command("cleanlinked") & admin_filter)
...
@BAD.on_message(command("permapin") & admin_filter)
